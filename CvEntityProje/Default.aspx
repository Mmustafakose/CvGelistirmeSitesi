...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Mustafa Köse</a></h1>
            <p class="top_hdp mt-2">Yönetim Bilişim Sistemleri
            </p>
        </div>
        <!-- header -->
        <header>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Text="Gönder" onclick="btnGonder_Click"/>
            ...
            <div class="cpy-right text-center">
                <p>
                    © 2024 Conjoint. All rights reserved | Design by Mustafa
